...
const [selectedAgeGroup, setSelectedAgeGroup] = useState('')
  ...
  const [ageLists, setageLists] = useState ([
    {id: 1, ageGroup: "19 months - 2.4 years", 
    Fresident: "$1125", P2resident: "$450", P3resident: "$675", 
    FnonResident: "$1175",
    P2nonResident: "$470",
    P3nonResident: "$705"
  },
    {id: 2, ageGroup: "2.5 years - 5 years", Fresident: "$925", P2resident: "$370", P3resident: "$555", 
    FnonResident: "$975",
    P2nonResident: "$390",
    P3nonResident: "$585",
  },
  ...
  const visibleExpenses = selectedAgeGroup ? ageLists.filter(e => e.ageGroup === selectedAgeGroup) : defaultState;
   ...
   return (
    <Router>
      ...
      <Routes>
        ...
        <Route path="Childcare" element={<ChildCare ageLists={visibleExpenses} onSelectageGroup={ageGroup => setSelectedAgeGroup(ageGroup) } />} />
