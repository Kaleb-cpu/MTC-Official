...
export default function Home() {
  return (
    <>
      ...
      <section className="breakpoint-1"></section>
        ...
        <div className="cards">
          ...
          <Card className="card-parent" style={{ width: "18rem" }}>
            ...
            <Card.Body className="card-body">
              ...
              <Card.Text>
                There have been reports of coyote sightings in the area.
                Friendly reminder to educate yourself on wildlife awareness
              </Card.Text>
              <Button className="button">
                <a href="https://www.calgary.ca/parks/wildlife/urban-coyotes.html">
                  Learn More
                </a>
              </Button>
            </Card.Body>
          ...
          <Card className="card-parent" style={{ width: "18rem" }}>
            ...
            <Card.Body className="card-body">
              ...
              <Card.Text>You can now rent some of our facilities.</Card.Text>
              <Button className="button">
