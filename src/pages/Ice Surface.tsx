...
export default function IceSurface() {
  return (
   <>
      ...
      {/* main title */}
      <h1 className="teritary text-4xl font-5 mb-9 mt-10 md:text-7xl">Ice Surface</h1>
      ...
      <h3 className='teritary m-auto md:text-xl text-lg font-2 mt-3 mb-3'>Hockey Rink - McKenzie Towne Gate & McKenzie Towne Link SE</h3>
</div>
<h3 className='teritary m-auto md:text-xl text-lg font-2 mt-3 mb-3'>Stay tuned for updates</h3>
      <h2 className='teritary m-auto borderTop pt-5 ml-2 md:text-4xl text-2xl font-5 mt-5 mb-10'>When does MTC flood ice surfaces?</h2>
<div className='md:flex items-center justify-center'>
      ...
      <a href="/media/documents/Storm-Pond.pdf"><img className='w-1/2' src={StormPond} alt="storm-pond documentary" /></a>
</div>
    </>
  );
}
